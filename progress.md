...
- [ ] Agent 2 (Medical Analysis) — assigns ICD-10/CPT codes, outputs clinical summary
...
- [ ] Agent 5 (Submission & Monitor) — submits request, polls status, triggers appeal on denial
- [ ] Agent 6 (Denial & Appeal) — parses denial, writes counter-appeal, loops up to 3 levels
- [ ] Agent 7 (Claims Validation) — scans billing codes, assigns risk score
- [ ] Orchestrator — full state machine wired, branching logic complete, audit log active
- [ ] Human-in-the-loop escalation trigger working

### Phase 2B — Frontend UI
- [ ] Patient Intake Form (`PatientIntake.jsx`) complete
- [ ] Authorization Status Dashboard (`AuthorizationStatus.jsx`) with real-time agent progress
- [ ] Prompt Editor page (`PromptEditor.jsx`) — reviewers can view/edit YAML prompts from UI
...
> Use this section to jot down issues, decisions made, or things to come back to.
